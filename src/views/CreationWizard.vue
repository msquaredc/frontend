  ...
  <div>
    <md-steppers md-vertical md-linear :md-active-step.sync="active">
      <md-step id="zeroth" exact md-label="Name it" :md-editable="false" :md-done.sync="zeroth">
        <md-content>
          <span class="md-headline">Give your project a name</span>
          <md-field>
      ...
      <md-step
        id="second"
        md-label="Select relevant headers"
        :md-editable="false"
        :md-done.sync="second"
      >
        <md-content>
          <span class="md-headline">Select the questions:</span>
          <md-checkbox
            v-model="questions"
            v-for="title in heading"
            :value="title"
            :key="title.key"
          >{{title}}</md-checkbox>
          <md-button
            class="md-raised md-primary"
            @click="setRelevantHeaders(questions)"
